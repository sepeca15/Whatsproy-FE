      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View style={styles.statusSection}>
            ...
            {detailOfOrder.data?.cambiosEstado && detailOfOrder.data.cambiosEstado.length > 0 && (
        ...
        >
          ...
          <View style={styles.clientInfoContainer}>
            <View style={styles.clientAvatar}>
              <Text style={styles.clientAvatarText}>{detailOfOrder.data?.client.name.charAt(0).toUpperCase()}</Text>
            </View>
          ...
          {detailOfOrder.data?.infoLines?.direccion && (
            <View style={styles.addressContainer}>
              ...
              <Text style={styles.addressText}>{detailOfOrder.data.infoLines.direccion}</Text>
            </View>
          )}
        </Animated.View>
          ...
          {detailOfOrder.data?.infoLines?.notas && (
            <View style={styles.generalNotes}>
              ...
              <View style={styles.notesContainer}>
                <Text style={styles.generalNotesText}>{detailOfOrder.data.infoLines.notas}</Text>
              </View>
            </View>
          )}
        </Animated.View>
