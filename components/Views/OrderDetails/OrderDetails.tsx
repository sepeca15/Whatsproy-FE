    ...
    try {
      ...
      if (detailOfOrder.data?.id && keyDeleteType) {
        try {
          ...
          if (response.ok) {
            await handleDeleteOrder(detailOfOrder.data.id, resolvedKeyDeleteType, reason)
            if (isReserva) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          <TouchableOpacity style={styles.headerActionButton} onPress={() => setOrdrDeleteModalConfirm(true)}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent} showsVerticalScrollIndicator={false}>
        {detailOfOrder.data?.reclamo && (
          <Animated.View
            style={[styles.orderSummaryCard, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}
          >
          ...
          <Animated.View style={[styles.sectionCard, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
            ...
            <View style={styles.confirmActions}>
              ...
              <TouchableOpacity style={[styles.actionButton2]} onPress={handleCancelOrder}>
                ...
                >
                  <FormattedMessage id="cancelOrder" defaultMessage="Cancelar" />
                </Text>
              </TouchableOpacity>
            </View>
          </Animated.View>
        ...
        {!isReserva && <Animated.View style={[styles.sectionCard, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
          <View style={styles.sectionHeader}>
            <MaterialIcons
              name={detailOfOrder.data?.isDomicilio ? "delivery-dining" : "store"}
              size={20}
              color={Colors.light.primary}
            />
            <Text style={styles.sectionTitle}>
          ...
          <View style={styles.deliveryMethodContainer}>
            <View
              style={[
                styles.deliveryMethodBadge,
                {
                  backgroundColor: detailOfOrder.data?.isDomicilio
            ...
            >
              <MaterialIcons
                name={detailOfOrder.data?.isDomicilio ? "home" : "storefront"}
                size={24}
              ...
              >
                {detailOfOrder.data?.isDomicilio ? (
                  <FormattedMessage id="homeDelivery" defaultMessage="Entrega a domicilio" />
                ) : (
            ...
            <Text style={styles.deliveryMethodDescription}>
              {detailOfOrder.data?.isDomicilio ? (
                <FormattedMessage
                  ...
                  defaultMessage="El pedido será entregado en la dirección del cliente"
                />
              ) : (
                <FormattedMessage
                  id="storePickupDescription"
                  defaultMessage="El cliente retirará el pedido en el local"
                />
              )}
            </Text>
          </View>
