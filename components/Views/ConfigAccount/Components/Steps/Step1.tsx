  ...
  return (
    <View style={styles.containerStep1}>
      <View style={styles.containerForm}>
        <InputField marginTop={20} type="text" label={<FormattedMessage id="enterFirstName" />} placeholder="Name" onChangeText={(text) => handleChangeInputs('nombre', text)} />
        <InputField marginTop={20} type="text" label={<FormattedMessage id="enterLastName" />} placeholder="Last name" onChangeText={(text) => handleChangeInputs('apellido', text)} />
      </View>
