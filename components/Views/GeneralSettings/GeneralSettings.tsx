        ...
        <View style={styles.containerGlobal}>
          <View style={styles.logoSection}>
            <View style={styles.logoHeader}>
              ...
              <CustomText style={styles.sectionTitle}>
                <FormattedMessage id="logoSection" defaultMessage="Logo de la empresa" />
              </CustomText>
            </View>
            ...
            >
              {form.logo ? (
                <>
                  <Image source={{ uri: form.logo }} style={styles.logoImage} alt="Company Logo" />
                ...
                <View style={styles.logoPlaceholder}>
                  ...
                  <CustomText style={styles.logoPlaceholderText}>
                    <FormattedMessage id="addLogo" defaultMessage="Agregar logo" />
                  </CustomText>
                </View>
              )}
              ...
              {uploadingLogo && (
                <View style={styles.logoLoadingOverlay}>
                  ...
                  <CustomText style={styles.uploadingText}>
                    <FormattedMessage id="uploadingLogo" defaultMessage="Subiendo..." />
                  </CustomText>
                </View>
              )}
            </TouchableOpacity>
            ...
            <CustomText style={styles.logoHint}>
              <MaterialIcons name="touch-app" size={14} color={Colors.light.icon} />{" "}
              <FormattedMessage
                id="logoHint"
                defaultMessage={form.logo ? "Toca para cambiar" : "Toca para agregar tu logo"}
              />
            </CustomText>
          </View>
          ...
          <View style={styles.addressSection}>
            <View style={styles.addressHeader}>
              ...
              <CustomText style={styles.sectionTitle}>
                <FormattedMessage id="companyAddress" defaultMessage="Dirección de la empresa" />
              </CustomText>
            </View>

            <View style={styles.addressInputContainer}>
              <InputField
                icon={<MaterialIcons name="place" size={20} color={Colors.light.icon} style={{ marginLeft: 12 }} />}
          ...
          <View style={styles.form}>
            <View style={styles.container1}>
              ...
              <View style={styles.notifReserva}>
                <View style={styles.row1}>
                  <CustomText style={styles.textInput}>
                    <FormattedMessage id="assistentEnabled" defaultMessage="Asistente habilitado" />
                  </CustomText>
                  <Switch
                    isChecked={form.assistentEnabled}
                    onToggle={() => handleInputChange("assistentEnabled", !form.assistentEnabled)}
                    size="lg"
                    colorScheme="primary"
                  />
                </View>
              ...
              <View style={styles.notifReserva}>
                <View style={styles.containerNotifReserva}>
                  <View style={styles.row1Custom}>
                    <CustomText style={styles.textInput}>
                      <FormattedMessage id="notifyDailyMenuLabel" defaultMessage="Notificar menú diario" />
                    </CustomText>
                    <Switch
                      isChecked={form.notificarMenuDiario}
                      onToggle={() => handleInputChange("notificarMenuDiario", !form.notificarMenuDiario)}
                      size="lg"
                      colorScheme="primary"
                    />
                  </View>
              ...
              {isDeliveryService && (
                <View style={styles.notifReserva}>
                  <View style={styles.containerNotifReserva}>
                    <View style={styles.row1Custom}>
                      <CustomText style={styles.textInput}>
                        <FormattedMessage id="pickupInStoreLabel" defaultMessage="Retiro en sucursal" />
                      </CustomText>
                      <Switch
                        isChecked={form.retiroEnSucursal}
                        onToggle={() => handleInputChange("retiroEnSucursal", !form.retiroEnSucursal)}
                        size="lg"
                        colorScheme="primary"
                      />
                    </View>
