...
const GeneralConfig = () => {
    ...
    return (
        <View style={styles.container}>
            <CustomText style={{ fontSize: 30, textAlign: 'center', fontWeight: 'bold', paddingTop: 20, }}>Configurcion General</CustomText>
            <CustomText style={{ textAlign: 'center', color: '#b6b6b6', paddingBottom: 20, }}>Ajusta los parámetros de tu negocio</CustomText>
            <View style={styles.form}>
                ...
                <View style={styles.notifReserva}>
                    <View style={styles.row1}>
                        <CustomText>Abrir/Cerrar local</CustomText>
                        <Switch
...

                {
                    ...
                    <View style={styles.colum}>
                        <View style={styles.notifReserva}>
                            <View style={styles.row1}>
                                <CustomText>Notificar Reserva?</CustomText>
                                <Switch
                            ...
                            <View style={styles.row2}>
                                ...
                                <CustomText style={{ maxWidth: '95%' }}>Si activas esta opcion, se le notificara al usuario el tiempo antes de realizarse la reserva</CustomText>
                            </View>
                        </View>
                        <View>
                            <InputField
                        ...
                        </View>
                        {
                            ...
                            <View>
                                <InputField
                                    ...
                                    label="Notificar al usaurio X horas antes"
                                    placeholder="Ingresa el intervalo"
