...
const StatusView = () => {
        ...
        >
          <View style={styles.orderColumn}>
            ...
            <Text
              ...
              style={[styles.orderText, { color: colors.text }]}
            >
              {item.order}
            </Text>
          </View>
          ...
          <View style={styles.actionsColumn}>
            ...
            <TouchableOpacity
              style={[
                styles.actionButton,
                styles.editButton,
                { borderColor: isDark ? "#2A2D30" : "#E8EDF2" },
              ]}
  ...
  return (
    ...
    >
      <CustomHeader
        title={
          <FormattedMessage id="statusTitlePage" defaultMessage="Status" />
        }
        onBack={() => router.back()}
        showBackButton
      />
          ...
          {loading ? (
            ...
            <View>
              <View
                style={[
                  styles.tableHeader,
                  { backgroundColor: isDark ? "#2A2D30" : "#F5F7FA" },
                ]}
              >
                <Text
                  allowFontScaling={false}
